...
CN.dart = (function() {
    var
         ...
         * @private
         */
        Ad=function (placement,funcs,tile,store){
    ...
    return {
        ...
        refresh : function(placement,params) {
            ...
            if ( p.length < 1 ){jQuery('script[id*="prscr"], .prWrap').remove();}
    ...
    var
        ...
        _resize = function() {
            try {
                ...
                return CN.debug.user(e, [this, this.id]);
            }
...
CN.internal = (function() {
    ...
    return {
         ...
         * environment variable. Requires CN.platformEnvironment to
         * be declared.
        ...
        getTeamsiteServer : function() {
            return servers[CN.site.env] || 'serverNotAvailable';
        }
    };
})();
...
CN.user = (function() {
    ...
    return {
         ...
         */
        isLoggedIn : function() {
            return (CN.cookie.get('amg_user_record'));
        },
